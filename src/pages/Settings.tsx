...
import { Save, Bell, Shield, Palette, Globe, Database, CreditCard, Users } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Receive email notifications for sales and inventory alerts</p>
                </div>
                <button
          ...
          <div className="space-y-6">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                Payment gateway integration would be configured here. This is a placeholder for payment settings.
              </p>
            </div>
          </div>
        );
      ...
      case 'users':
        return (
          <div className="space-y-6">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                User management and role-based access control would be configured here.
              </p>
            </div>
          </div>
        );
      ...
      case 'security':
        return (
          <div className="space-y-6">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                Security settings, two-factor authentication, and access controls would be configured here.
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-medium text-gray-900">Enable Backups</h3>
